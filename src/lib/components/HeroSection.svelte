...
<section class="hero">
  <div class="hero-showcase text-center bold">
    ...
    <h4 class="italic semi-bold">
      There'es no need to make the same mistake I made.
    </h4>
  ...
  <div class="hero-text white text-center">
    ...
    <p class="light-grey">
      I move to Spain 7 years ago. The process was painful and difficult. I
    ...
    <Button class="mt-m" on:click={() => console.log("clicked")}>Purchase E-book for $10</Button>
    {/if}
  </div>
</section>
